...
<section class="container">
  ...
  <div class="demo">
    <div class="row">
      ...
      <div class="col-xsmall-2 col-small-offset-10">
        <div class="box"></div>
      </div>
...
<section class="container">
  ...
  <p>Apply modifier classes to columns to adjust their position within the grid.</p>
  ...
  <p class="demo-format"><code>-reverse</code></p>
